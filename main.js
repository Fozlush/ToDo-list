...
function templateEdit(index){
    ...
    return `
        <div class='popup-header'>
            ...
            <button onClick='popupClose()' class='popup-close'>x</button>
        </div>
        ...
        <button onClick='addSubTask()' class='add-sub-task'>+</button>
        <button onClick='editConfirm(${index})' class='popup-done'>change</button>
    `
}
...
function templatePopupSubs(index){
    return `
        <div id='popup-subtask-${index}' class='popup-subtask popup-subtask-${index}'>
            ...
            <p>- subtask #${index+1}</p>
            <button onClick='subDel(${index})' class='sub-del'>del</button>
        </div>
    `
}
